            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px rounded" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{ asset('placeholder_images/logo.svg') }}" alt="user" class="rounded-1" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                            <a href="#" class="menu-link px-5">
													...
													<img class="w-15px h-15px rounded-1 ms-2" src="{{asset('dashboard-assets/demo-1/media/flags/' . ( isArabic() ? 'saudi-arabia' : 'united-states' ) . '.svg')}}" alt="" /></span></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('change-language','ar') }}" class="menu-link d-flex px-5 @if( isArabic() == 'ar' ) active @endif">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1" src="{{asset('dashboard-assets/demo-1/media/flags/saudi-arabia.svg')}}" alt="" />
                                            </span>{{ __("Arabic") }}
                                    </a>
                                </div>
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('change-language','en') }}" class="menu-link d-flex px-5 @if( ! isArabic() ) active @endif">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1" src="{{asset('dashboard-assets/demo-1/media/flags/united-states.svg')}}" alt="" />
                                            </span>{{ __("English") }}
                                    </a>
                                </div>
