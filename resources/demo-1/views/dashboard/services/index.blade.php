...
@section('content')
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex justify-content-end" id="add_btn" data-bs-toggle="modal" data-bs-target="#crud_modal" data-kt-docs-table-toolbar="base">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-original-title="Coming Soon" data-kt-initialized="1">
                        ...
                        <!--end::Svg Icon-->{{ __('add new service') }}</button>
                    <!--end::Add customer-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
    ...
    <form id="crud_form" class="ajax-form" action="{{ route('dashboard.services.store') }}" method="post" data-success-callback="onAjaxSuccess" data-error-callback="onAjaxError">
        @csrf
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fv-row mb-2 fv-plugins-icon-container">
                            <label class="form-label fs-6 fw-bold mb-3">{{ __("Description in Arabic") }}</label>
                            <textarea class="form-control required form-control-lg form-control-solid" placeholder="{{ __('Description in Arabic') }}" name="description_ar" id="description_ar_inp" data-kt-autosize="true"></textarea>
                            <div class="fv-plugins-message-container invalid-feedback" id="description_ar"></div>
                        </div>
                        <div class="fv-row mb-2 fv-plugins-icon-container">
                            <label class="form-label fs-6 fw-bold mb-3">{{ __("Description in English") }}</label>
                            <textarea class="form-control required form-control-lg form-control-solid" placeholder="{{ __('Description in English') }}" name="description_en" id="description_en_inp" data-kt-autosize="true"></textarea>
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/services.js') }}"></script>
    ...
    <script>
        $(document).ready(function () {
            $("#add_btn").click(function (e) {
                ...
                $("#form_title").text(__('add new service'));
                $("[name='_method']").remove();
                $("#crud_form").trigger('reset');
                $("#crud_form").attr('action', `/dashboard/services`);
