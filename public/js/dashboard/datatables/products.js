                    ...
                    render: function (data, type, row) {
                        return `
                            <div>
                                <!--begin::Info-->
                                <div class="d-flex flex-column justify-content-center">
                                    <a href="javascript:;" class="mb-1 text-gray-800 text-hover-primary">${row.category.name}</a>
                                </div>
                                <!--end::Info-->
                            </div>
                        `;
                        ...
                        <div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/products/${data.id}" class="menu-link px-3">
                                        ${__('Show')}
                                    </a>
                                </div>
                                <!--end::Menu item-->
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                $("#form_title").text(__('Edit product'));
                $('#images_container').hide();
                $('#structure_image_inp').css('background-image', `url('${data.full_structure_image_path}')`);
                $('#panel_image_inp').css('background-image', `url('${data.full_panel_image_path}')`);
                ...
                $("#category_id_inp").val(data.category_id).attr('selected', true);
                $(`#category_id_inp`).trigger('change');
