...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    <!--begin::Page bg image-->
    <style>body { background-image: url('{{ asset('dashboard-assets/demo-1/media/auth/bg10-dark.jpeg') }}'); } [data-theme="dark"] body { background-image: url({{ asset('dashboard-assets/demo-1/media/auth/bg10-dark.jpeg') }}'); }</style>
    <!--end::Page bg image-->
    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="d-flex flex-lg-row-fluid">
            ...
            <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                <!--begin::Image-->
                <img class="theme-light-show mx-auto mw-100 w-150px w-lg-350px mb-10 mb-lg-20" src="{{ asset('placeholder_images/logo.svg') }}" alt="" />
                <!--end::Image-->
                <!--begin::Title-->
                <h1 class="text-gray-800 fs-2qx fw-bold text-center mb-9" style="color: white !important">{{ __('ISO-Eagle : Admin Panel') }}</h1>
                <!--end::Title-->
            </div>
            <!--end::Content-->
        </div>
                    ...
                    <div class="d-flex flex-center flex-column-auto p-10">
                        ...
                        <div class="d-flex align-items-center fw-bold fs-6">
                            <span class="text-muted text-hover-primary px-2">
                                {{ __('Developed by Hossam Ghoneim') }}
                            </span>
                        </div>
                        <!--end::Links-->
                    </div>
